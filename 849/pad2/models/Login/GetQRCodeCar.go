...
func GetQRCODECar(Data GetQRReq) models.ResponseResult2 {
	...
	Algorithm.IPadDeviceType = Algorithm.CarDeviceType
	...
	DeviceToken, err := IPadGetDeviceToken(deviceid, Algorithm.CarModel, Data.DeviceName, Algorithm.CarDeviceType, int32(Algorithm.CarVersion), *httpclient, Data.Proxy, Algorithm.MmtlsShortHost)
	if err != nil {
	...
	req := &mm.GetLoginQRCodeRequest{
		BaseRequest: &mm.BaseRequest{
			...
			ClientVersion: proto.Int32(int32(Algorithm.CarVersion)),
			DeviceType:    []byte(Algorithm.CarDeviceType),
