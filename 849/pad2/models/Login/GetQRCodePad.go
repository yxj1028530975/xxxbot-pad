...
func GetQRCODEPad(Data GetQRReq) models.ResponseResult2 {
	...
	DeviceToken, err := IPadGetDeviceToken(deviceid, Algorithm.AndroidPadModel, Data.DeviceName, Algorithm.AndroidPadDeviceType, int32(Algorithm.AndroidPadVersion), *httpclient, Data.Proxy, Algorithm.MmtlsShortHost)
	if err != nil {
	...
	req := &mm.GetLoginQRCodeRequest{
		BaseRequest: &mm.BaseRequest{
			...
			ClientVersion: proto.Int32(int32(Algorithm.AndroidPadVersion)),
