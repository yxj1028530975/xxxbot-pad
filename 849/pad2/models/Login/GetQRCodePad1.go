...
func GetQRCODEPad1(Data GetQRReq) models.ResponseResult2 {
	//初始化Mmtls
	...
	Algorithm.IPadVersion = Algorithm.AndroidVersion1
	aeskey := []byte(lib.RandSeq(16)) //获取随机密钥
	deviceid := Data.DeviceID
	devicelIdByte, _ := hex.DecodeString(deviceid)

	DeviceToken, err := IPadGetDeviceToken(deviceid, Algorithm.AndroidPadModel, Data.DeviceName, Algorithm.AndroidPadDeviceType, int32(Algorithm.AndroidVersion1), *httpclient, Data.Proxy, Algorithm.MmtlsShortHost)
	if err != nil {
